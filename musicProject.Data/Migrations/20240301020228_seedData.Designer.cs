...
namespace musicProject.Data.Migrations
{
    ...
    [Migration("20240301020228_seedData")]
            ...
            modelBuilder.Entity("musicProject.Data.Entities.Album", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ArtistId = 1,
                            Genre = "rock",
                            Released = new DateTime(2024, 2, 29, 21, 2, 27, 936, DateTimeKind.Local).AddTicks(8552),
                            Title = "TESTAlbum"
                        });
                });
            ...
            modelBuilder.Entity("musicProject.Data.Entities.Track", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AlbumId = 1,
                            ArtistId = 1,
                            Released = new DateTime(2024, 2, 29, 21, 2, 27, 936, DateTimeKind.Local).AddTicks(8614),
                            Title = "testTitle",
                            TrackNumber = 1
                        },
                        new
                        {
                            ...
                            AlbumId = 1,
                            ArtistId = 1,
                            Released = new DateTime(2024, 2, 29, 21, 2, 27, 936, DateTimeKind.Local).AddTicks(8618),
                            Title = "testTitle2",
                            TrackNumber = 2
                        });
                });
